...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-head">
                <a class="btn ink-reaction btn-floating-action btn-lg btn-primary btn-fixed-right"  href="<?php echo e(action('AdminCallsController@addCall')); ?>"><i class="glyphicon glyphicon-plus"></i></a>
            ...
            <div class="card-body tab-content">
                <div class="tab-pane <?php if(!Session::has('calls_tab')): ?> active <?php endif; ?>" id="all-calls">
                    ...
                    &nbsp;
                        <a href="<?php echo e(action('AdminCallsController@calls')); ?>" style="text-decoration: none" class="tile-content ink-reaction">
