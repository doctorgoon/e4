...
<div class="form-group">
    <?php echo Form::label('nameSelect', 'Nom'); ?> <br>
    <?php echo Form::select('nameSelect', [null=>'Choisir'] + getSpirometersLits() , ['class' => 'form-control']); ?>
...
<div class="form-group">
    <div class="checkbox checkbox-styled">
        <label>
            <?php echo Form::checkbox('available', 1); ?> <span>Disponible</span> &nbsp;
        </label>
        <label>
            <?php echo Form::checkbox('expedited', 1); ?> <span>Expédié</span>
        </label>
    </div>
</div>
