<?php echo $__env->make('partials.clients-search-bar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <?php echo e(Form::hidden('invisible', $call->id)); ?>
                ...
                <form class="form" role="form">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group floating-label">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('lastname', $call->client_name, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group floating-label">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('company', $call->company, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('mobile', $call->mobile, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('phone', $call->phone, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('email', $call->email, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
                    ...
                    <div class="card-actionbar">
                        <div class="card-actionbar-row">
                            <a class="btn btn-flat" href="<?php echo e(action('AdminCallsController@showCall', [$call->id])); ?>">Retour</a>
