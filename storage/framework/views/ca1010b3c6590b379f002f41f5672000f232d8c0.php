            ...
            <div class="card">
                <div class="card-head style-<?php echo e(Config::get('status_color.' . $call->status)); ?>">
                    <h3 style="padding-left: 20px;">
                        ...
                        <a href="<?php echo e(action('CallsController@destroyCall', [$call->id])); ?>" style="padding-top: 10px; padding-right: 30px" class="btn btn-icon pull-right">
                            <i class="glyphicon glyphicon-trash" style="display: inline; font-size: 25px; line-height: 0px;"></i></a>

                        <a href="<?php echo e(action('CallsController@editCall', [$call->id])); ?>" style="padding-top: 10px; padding-right: 30px" class="btn btn-icon pull-right">
