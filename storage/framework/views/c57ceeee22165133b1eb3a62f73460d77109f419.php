        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-head style-<?php echo e(Config::get('status_color.' . $call->status)); ?>">
                    <a class="btn ink-reaction btn-floating-action btn-lg btn-default btn-fixed-right"  href="<?php echo e(action('ClientsController@addClientCall', [$call->id])); ?>"><i class="glyphicon glyphicon-plus"></i></a>
