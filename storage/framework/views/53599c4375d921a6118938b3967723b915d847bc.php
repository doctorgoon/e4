            ...
            <div class="card">
                ...
                <div class="card-head style-info">
                    ...
                    <div class="tools pull-left" style="padding: 8px">
                        <a href="<?php echo e(action('ClientsController@clients')); ?>">
                    ...
                    <div class="tools" style="padding-top: 5px">
                        <a class="btn btn-floating-action btn-default-light" href="<?php echo e(action('ClientsController@addClient')); ?>"><i class="fa fa-plus"></i></a>
                    </div>
                </div><!--end .card-head -->
                <!-- END SEARCH HEADER -->
                            ...
                            <div class="margin-bottom-xxl">
                                ...
                                <div class="btn-group btn-group-sm pull-right">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right animation-dock" role="menu">
                                        ...
                                        <li><a href=<?php echo e(action('ClientsController@clients')); ?>>Nom</a></li>
                                    ...
                                    <div class="hbox-column v-top">
                                        <div class="clearfix">
                                            <div class="col-lg-12 margin-bottom-lg">
                                                <a class="text-lg text-medium" href=<?php echo e(action('ClientsController@showClient', [$client->id])); ?>><?php echo e($client->firstname); ?> <?php echo e($client->lastname); ?> &nbsp; <span style="color: #9c9c9c; font-size: smaller"><i><?php echo e($client->company); ?></i></span> </a>
                                            </div>
                                        </div>
