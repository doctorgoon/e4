                                        ...
                                        <?php foreach( $products as $product ): ?>
                                            <?php if($product->expedited != 1): ?>
                                                <li class="tile">
                                                    ...
                                                    <a href="<?php echo e(action('ProductsController@destroyProduct', [$product->id])); ?>" class="pull-right" style="padding-bottom: 10px; padding-right: 20px">Supprimer
                                                    ...
                                                    <a href="<?php echo e(action('ProductsController@expeditProduct', [$product->id])); ?>" style="padding-bottom: 10px; padding-right: 20px" class="pull-right">Expédier
                                            ...
                                            <?php if($product->expedited == 1): ?>
                                                <li class="tile">
                                                    <a href="<?php echo e(action('ProductsController@showProduct', [$product->id])); ?>" class="tile-content ink-reaction">
                                                        ...
                                                        <a href="<?php echo e(action('ProductsController@expeditProduct', [$product->id])); ?>" style="padding-bottom: 10px; padding-right: 20px" class="pull-right">Stocker
