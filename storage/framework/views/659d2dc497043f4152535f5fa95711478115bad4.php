...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card">
            <a href="<?php echo e(action('AdminCallsController@calls')); ?>" style="text-decoration: none">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card">
            <a href="<?php echo e(action('AdminClientsController@clients')); ?>" style="text-decoration: none">
            <div class="card-body no-padding">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card">
            <a href="<?php echo e(action('AdminProductsController@products')); ?>" style="text-decoration: none">
                <div class="card-body no-padding">
