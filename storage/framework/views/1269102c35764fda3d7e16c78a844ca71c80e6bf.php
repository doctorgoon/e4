            ...
            <ul class="header-nav header-nav-profile">
                <li class="dropdown">
					...
					<span class="profile-info">
						<?php echo e(Session::get('user_firstname')); ?> <?php echo e(Session::get('user_lastname')); ?>
                    ...
                    <ul class="dropdown-menu animation-dock">
                        ...
                        <li><a href="<?php echo e(action('AdminController@myProfile')); ?>">Mon profil</a></li>
                        <li><a href="<?php echo e(action('AdminController@myNotes')); ?>"><?php if(Session::get('user_notes_count') != 0): ?><span class="badge style-danger pull-right"><?php echo e(Session::get('user_notes_count')); ?></span> <?php endif; ?> Mes notes</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo e(action('AdminController@logoutUser')); ?>"><i class="fa fa-fw fa-power-off text-danger"></i> Déconnexion</a></li>
...
<div id="base">
    ...
    <div id="content">
        ...
        <div class="section-body contain-lg">
            <!--<div class="col-lg-12">
                <h2 class="text-primary" style="margin: 0px;"><?php echo $__env->yieldContent('title'); ?></h2>
            </div>-->
