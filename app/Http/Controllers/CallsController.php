...
class CallsController extends Controller
{
    ...
    public function myCalls()
    {
        ...
        return redirect(action('CallsController@calls'));
    }
    ...
    public function showCall($id)
    {
        ...
        if ( ! is_null($call)) {
            ...
            return view('calls.show-call', compact('call'));
        }
    ...
    public function addClientCall($id)
    {
        ...
        return view('calls.add-call', compact('client'));
    }
    ...
    public function postAddCall(Request $request)
    {
       $this->validate($request, [
        ...
        $url = action('CallsController@showCall', [ $call->id ]);
    ...
    public function editCall($id)
    {
        ...
        if ( ! is_null($id)) {
            return view('calls.edit-call', compact('call'));
        }
    ...
    public function destroyCall($id)
    {
        ...
        if ( ! is_null($id)) {
            ...
            return view('calls.delete-call', compact('call'));
        }

        abort(404);
    }

    public function postDestroyCall($id, Request $request)
    {
        $call = Calls::find($id);
        ...
        if ( ! is_null($id)) {
            ...
            Session::flash('flash_message', 'L\'appel a bien été supprimée');
    ...
    public function addTicket($id)
    {
        ...
        if ( ! is_null($id)) {
            ...
            return view('calls.form-ticket', compact('call'));
        }
    ...
    public function postAddTicket($id, Request $request)
    {
        ...
        return redirect(action('CallsController@showCall', [ $ticket->call_id ]));
    }
    ...
    public function editTicket($id)
    {
        ...
        if ( ! is_null($ticket)) {
            ...
            if ( ! is_null($call)) {
                return view('calls.form-ticket', compact('ticket', 'call'));
            }
        }
    ...
    public function setStatus($id)
    {
        ...
        if ( ! is_null($call)) {
            return view('calls.set-status', compact('call'));
        }
    ...
    public function pairCall($id)
    {
        ...
        if ( ! is_null($call)) {
            ...
            return view('calls.pair-call', compact('call'));
        }
