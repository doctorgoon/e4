...
@section('content')
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card">
            <a href="{{ action('CallsController@calls') }}" style="text-decoration: none">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card">
            <a href="{{ action('ClientsController@clients') }}" style="text-decoration: none">
            <div class="card-body no-padding">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card">
            <a href="{{ action('ProductsController@products') }}" style="text-decoration: none">
                <div class="card-body no-padding">
