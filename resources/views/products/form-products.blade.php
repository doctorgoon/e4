...
<div class="form-group">
    {!! Form::label('nameSelect', 'Nom') !!} <br>
    {!! Form::select('nameSelect', [null=>'Choisir'] + getSpirometersLits() , ['class' => 'form-control']) !!}
</div>
...
<div class="form-group">
    <div class="checkbox checkbox-styled">
        <label>
            {!! Form::checkbox('available', 1) !!} <span>Disponible</span> &nbsp;
        </label>
        <label>
            {!! Form::checkbox('expedited', 1) !!} <span>Expédié</span>
        </label>
    </div>
</div>
