            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-head style-info">
                        ...
                        <a href="{{ action('ClientsController@destroyClient', [$client->id]) }}" style="padding-top: 25px; padding-right: 30px" class="btn btn-icon pull-right">
                        <i class="glyphicon glyphicon-trash" style="display: inline; font-size: 25px; line-height: 0px;"></i></a>

                        <a href="{{ action('ClientsController@editClient', [$client->id]) }}" style="padding-top: 25px; padding-right: 30px" class="btn btn-icon pull-right">
                    ...
                    <form class="form" role="form">
                            ...
                            <div class="tab-pane" id="calls">
                                <div class="row">
                                    <div class="col-lg-12">
                                        @foreach($calls as $call)
                                            <div class="card">
                                                <div class="card-body no-padding">
                                                    <ul class="list">
                                                        <li class="tile">
                                                            <a href="{{ action('CallsController@showCall', [$call->id]) }}" style="text-decoration: none" class="tile-content ink-reaction">
                                                                <div class="tile-icon">
                                        ...
                                        @endforeach
                                            <a href="{{ action('CallsController@addClientCall', [$client->id])  }}" class="btn ink-reaction btn-info">Ajouter un appel</a>
                                    </div>
                                </div>
                            </div><!--end .tab-pane-->
                        </div>
                        ...
                        <div class="card-actionbar">
                            ...
                            <div class="card-actionbar-row">
                                <a class="btn btn-flat btn-danger" href="{{ action('ClientsController@destroyClient', [$client->id]) }}">Supprimer Client</a>
                            </div>--><!--end .card-actionbar-row -->
